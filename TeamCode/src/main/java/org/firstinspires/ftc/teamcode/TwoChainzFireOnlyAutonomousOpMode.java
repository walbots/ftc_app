...
@Autonomous(name="TwoChainzFireOnlyAuto", group="Walbots")
public class TwoChainzFireOnlyAutonomousOpMode extends OpMode
{
    ...
    static public final double INTERVAL_DRIVE2    = 0f;
